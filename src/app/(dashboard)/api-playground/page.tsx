...
const ENDPOINTS: CategoryDef[] = [
    {
        ...
        endpoints: [
            ...
            },
            {
                ...
                params: [
                    { name: "ticker", type: "query", required: true, description: "Stock ticker", placeholder: "AAPL" },
                ],
            },
            {
                method: "GET",
                path: "/earnings/surprises",
                description: "Historical EPS surprises and magnitude",
                params: [
                    { name: "tickers", type: "query", required: true, description: "Comma-separated tickers", placeholder: "AAPL,MSFT" },
                ],
            },
            {
                method: "GET",
                path: "/earnings/movers",
                description: "Top post-earnings stock movers",
                params: [],
            },
            {
                method: "GET",
                path: "/earnings/guidance",
                description: "Extracted corporate forward guidance statements",
                params: [
                    { name: "tickers", type: "query", required: true, description: "Comma-separated tickers", placeholder: "AAPL,MSFT" },
                ],
            },
            {
                ...
                description: "Batch NLP sentiment analysis over earnings transcripts",
                params: [
                    { name: "tickers", type: "query", required: true, description: "Comma-separated tickers", placeholder: "AAPL,MSFT" },
                ],
            },
            {
                ...
                description: "Top performing analysts for stock predictions",
                params: [
                    { name: "ticker", type: "query", required: true, description: "Stock ticker", placeholder: "AAPL" },
                ],
            },
            {
                ...
                description: "Cash flow mapping from ops to buybacks",
                params: [
                    { name: "ticker", type: "path", required: true, description: "Stock ticker", placeholder: "AAPL" },
                ],
            },
            {
                ...
                description: "AI-driven detection of market-wide earnings anomalies",
                params: [
                    { name: "tickers", type: "query", required: true, description: "Comma-separated tickers", placeholder: "AAPL,MSFT" },
                ],
            },
