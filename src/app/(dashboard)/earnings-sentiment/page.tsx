...
Provide a brief analysis output ONLY as valid JSON matching exactly this schema, with no markdown formatting or extra text:
{
  "score": float (1-100 indicating sentiment, 50 neutral),
  "bullishPoints": ["point 1", "point 2"],
  "bearishPoints": ["point 1", "point 2"],
  "bottomLine": "single sentence summary"
}
...
Be specific and data-driven.`
            ...
            if (d.reply) {
                try {
                    ...
                    setDeepAnalysis({ score: 50, bullishPoints: [], bearishPoints: [], bottomLine: "Failed to parse analysis." });
                }
            }
        } catch {
            setDeepAnalysis({ score: 50, bullishPoints: [], bearishPoints: [], bottomLine: "Failed to generate analysis." });
        } finally {
                                ...
                                {deepLoading ? (
                                    ...
                                    <div className="mt-4">
                                        <SentimentBar 
                                            ...
                                            bullishPoints={deepAnalysis.bullishPoints} 
                                            bearishPoints={deepAnalysis.bearishPoints} 
                                            bottomLine={deepAnalysis.bottomLine} 
                                        />
                                    </div>
                                ) : (
